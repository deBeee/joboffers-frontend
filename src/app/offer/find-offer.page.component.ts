...
@Component({
  ...
  standalone: true,
  imports: [OfferCardComponent, ReactiveFormsModule, NgIf],
  template: `
    <section class="pt-10 min-w-">
      ...
      <div>
        ...
        <div class="max-w-md mx-auto pl-1 pt-1">
          <p
            *ngIf="submitted && inputControl.errors?.['required']"
            class="text-xs text-red-600 dark:text-red-500 text-left"
          >
            Provide offer ID
          </p>
        </div>
